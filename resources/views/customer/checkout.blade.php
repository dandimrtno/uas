        ...
        <h3 class="card-header">Checkout</h3>
            <form role="form" method="post" action="{{ route('cart.bayar')  }}" enctype="multipart/form-data">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        <label>Address</label>
                       <input type="text" class="form-control" id="address" name="address" placeholder="Masukkan Alamat Lengkap" autofocus required>
                    </div>
                    <br>
                    <!-- <div class="form-group">
                        <label>Catatan</label>
                        <textarea type="text" class="form-control" name="catatan" id="catatan" placeholder="Masukkan Alamat Lengkap" cols="30" rows="5"></textarea>
                    </div> -->
