...
Route::get('/home/clothing', [HomeController::class, 'clothing'])->name('products.clothing');
Route::get('/home/accessories', [HomeController::class, 'accessories'])->name('products.accessories');
